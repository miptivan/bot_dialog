...
async def stop_list(callback: CallbackQuery, button: Button, dialog_manager: DialogManager):
    await dialog_manager.next()


async def region_card(callback: CallbackQuery, button: Button, dialog_manager: DialogManager):
